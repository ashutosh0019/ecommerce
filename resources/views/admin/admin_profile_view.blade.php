    ...
    <section class="content">
        ...
        <div class="box box-widget widget-user">
					...
					<div class="widget-user-image">
					  <img src="{{ (!empty($adminData->profile_photo_path)) ? url('upload/admin_images/'.$adminData->profile_photo_path):url('upload/no_image.jpg') }}" style="width:100px; height:100px; border-radius: 50%;" alt="User Avatar">
					</div>
